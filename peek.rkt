  ...
  (syntax-rules ()
    ...
    [(-< <expr1> <expr2> ...)
     (let/cc cont
       ...
       (add-choice-to-store! (lambda () (quote (-< <expr2> ...))))
       <expr1>)]))
...
; add a choice to the choices store -> can we move this to add-choice?
(define (add-choice-to-store! choice)
  (set! choices-store
        (cons choice choices-store)))
